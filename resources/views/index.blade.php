...
<head>
  ...
  <link href="{{asset('assets/css/google_font.css')}}" rel="icon">
...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="mt-lg-5 col-lg-8 pt-4 pt-lg-0 content">
            <h3>Software Engineer &amp; Web Developer.</h3>
            <p class="fst-italic">
                I have a strong understanding of software design principles and I am constantly seeking to improve my skills and stay up-to-date with the latest technologies and trends in the industry.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-balloon-fill"></i> <strong>Birthday:</strong> <span>9 Oct 1999</span></li>
                  <li><i class="bi bi-globe"></i> <strong>Website:</strong> <span>dream-dev.in</span></li>
        ...
        <div class="row skills-content">
          <div class="col-lg-6">
            @foreach($skills->take(3) as $skill)
                <div class="progress">
                    <span class="skill">{{ $skill->skills }} <i class="val">{{ $skill->progress }}%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="{{ $skill->progress }}" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>I am a web developer and software engineer with over 5 years of experience. I have a strong background in both frontend and backend development, with expertise in HTML, CSS, JavaScript, PHP, and MySQL. I am passionate about creating responsive and user-friendly web applications that meet the needs of clients and end-users.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Shanmugam</h4>
              <p><em>I am a skilled and motivated web developer with 2+ years of experience in creating custom and responsive websites using various web technologies such as PHP, Laravel, HTML, CSS, JavaScript, and MySQL.</em></p>
              <ul>
                <li>71/144 Bazzar Street Sholinghur,Ranipet, TN</li>
                <li>631102</li>
                <li>chanshan250@gmail.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Education</h3>
            <div class="resume-item">
              <h4>Master of fullstack developer</h4>
              <h5>2022</h5>
              <p><em>Edureka</em></p>
              <p>Edureka is a leading online learning platform offering professional certification courses in trending technologies like Big Data, Cloud Computing, Artificial Intelligence, Blockchain, Data Science, and more</p>
            </div>
            <div class="resume-item">
              <h4>Bachelor of Compputer &amp; Application</h4>
              <h5>2015 - 2017</h5>
              <p><em>Thiruvallur University, Vellore, TN</em></p>
              <p>The university is dedicated to providing a stimulating and supportive learning environment that encourages academic excellence, critical thinking and lifelong learning.</p>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <h5>2021 - Present</h5>
              <p><em>Stellar Innovation, India, Tamil Nadu </em></p>
              <ul>
                <li>Experience in the design, development, and implementation of the graphic, layout, and production communication materials</li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              <div class="icon">
                ...
                <i><img width="48" height="48" src="{{asset('assets/img/web.png')}}" alt="web"/></i>
              </div>
              <h4><a href="">Website Development</a></h4>
              <p>I craft visually appealing and interactive websites that effectively communicate your brand's message and engage your target audience</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <p>I create an optimal user experience that adapts to mobile, tablet, and desktop environments</p>
            </div>
          </div>
            ...
            <div class="icon-box iconbox-pink">
              <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 600 600">
                  <path fill="#f5f5f5" d="M300,541.5067337569781C382.14930387511276,545.0595476570109,479.8736841581634,548.3450877840088,526.4010558755058,480.5488172755941C571.5218469581645,414.80211281144784,517.5187510058486,332.0715597781072,496.52539010469104,255.14436215662573C477.37192572678356,184.95920475031193,473.57363656557914,105.61284051026155,413.0603344069578,65.22779650032875C343.27470386102294,18.654635553484475,251.2091493199835,5.337323636656869,175.0934190732945,40.62881213300186C97.87086631185822,76.43348514350839,51.98124368387456,156.15599469081315,36.44837278890362,239.84606092416172C21.716077023791087,319.22268207091537,43.775223500013084,401.1760424656574,96.891909868211,461.97329694683043C147.22146801428983,519.5804099606455,223.5754009179313,538.201503339737,300,541.5067337569781"/>
                </svg>
                <i class="material-symbols-rounded">
                  margin
                </i>
              ...
              <p>I create visually appealing and interactive websites that captivate users and enhance their browsing experience</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              <div class="icon">
                ...
                <i><img width="48" height="48" src="{{asset('assets/img/database.png')}}" alt="database"/></i>

              </div>
              <h4><a href="">Back-end Development</a></h4>
              <p>I ensure smooth data management and efficient processing of user requests</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              <div class="icon">
                ...
                <i><img width="48" height="48" src="{{asset('assets/img/ecommerce.png')}}" alt="mobile-order"/></i>
              </div>
              <h4><a href="">E-commerce Development</a></h4>
              <p> I ensure a seamless and secure online shopping experience for your customers</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              <div class="icon">
                ...
                <i><img width="48" height="48" src="{{asset('assets/img/ui.png')}}" alt="web-design"/></i>
              </div>
              <h4><a href="">UI/UX Design Collaboration</a></h4>
              <p>I create visually stunning and user-friendly websites that captivate users and effectively convey your brand's message</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="footer">
    <div class="container">
      <h3>Shanmugam</h3>
      <p>If you're interested in learning more about my experience and skills, please don't hesitate to get in touch with me.</p>
      <div class="social-links">
        <a href="https://teams.microsoft.com/l/chat/0/0?users=chanshan250@gmail.com" class="teams"><i class='bx bxl-microsoft-teams'></i></a>
      ...
      <div class="credits">
        Designed by <a href="https://www.linkedin.com/in/shanmugam-n-b69866176/">Shanmugam</a>
      </div>
    </div>
  </footer>
  <!-- End Footer -->
  ...
  <a href="#" class="back-to-top bg-dark d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
  ...
  <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="66a2617d-1295-4f26-826f-8e0fb665570c";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
